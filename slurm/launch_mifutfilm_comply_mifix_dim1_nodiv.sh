#!/bin/bash
# FiLM + compliance + perturbation, MI-decoder fix, dim-1, div OFF.
#
#   bash slurm/launch_mifutfilm_comply_mifix_dim1_nodiv.sh
#
...
echo "[arm] FiLM=1 compliance=0.05 perturb=0.15 mi_exclude_perturbed=1 div=0  role_dim=1"
echo "[arm] -> roma_mifutagent_dim1_H8_r16p64_ep_film_comply_mifix_nodiv"
echo
ANALYZE=analyze_mifutfilm_comply_mifix_dim1_nodiv.sh bash "$HERE/run_mi_future.sh" 1 8
