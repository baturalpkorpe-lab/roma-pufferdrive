...
def init_wandb(args):
    ...
    try:
        ...
        default_name = (f"roma_mifutH{args.mi_horizon}_dim{args.role_dim}_"
...
def parse_args():
    ...
    p.add_argument("--wandb_name",    type=str,   default=None,
                   help="Wandb run name. Default: "
                        "roma_mifutH<H>_dim<D>_maps<N>_<seed>. Set it for "
                        "ablations (e.g. div_weight=0), which otherwise "
                        "collide with their control run's auto name.")
