...
def parse_args():
    ...
    # Role
    p.add_argument("--role_dim",      type=int,   default=2,
                   help="Role vector dimension. This branch: 2 (the intrinsic "
                        "dimensionality found in dim-4/8; tests whether 2 dims "
                        "decorrelate and match WOSAC).")
