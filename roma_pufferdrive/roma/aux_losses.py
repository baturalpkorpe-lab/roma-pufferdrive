...
class RomaAuxLoss(nn.Module):
    ...
    def mi_loss(self, role_z, emb_window):
        ...
        This is the strongest single gradient on the role encoder
        ...
        therefore to encode the map. Setting mi_emb_dim=64 drops road from the
        TARGET while leaving it available to the role encoder as input: the
        role may still see the road, it just is not rewarded for reciting it.
        """
